...
pub use self::x224::{DvcHandlerFactory, GfxHandler};
...
impl ActiveStageProcessor {
    pub fn new(config: InputConfig, 
        dvc_handler_factory: Option<Box<dyn DvcHandlerFactory + Send>>, connection_sequence_result: ConnectionSequenceResult) -> Self {
