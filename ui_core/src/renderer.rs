...
pub struct Renderer {
    ...
    _graphics_receiver: JoinHandle<Result<(), RendererError>>,
    _draw_handler: JoinHandle<Result<(), RendererError>>,
}
...
impl Renderer {
    pub fn new(
        ...
        Renderer {
            render_proxy: tx,
            _graphics_receiver: graphics_receiver,
