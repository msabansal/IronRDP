...
use clap::{clap_derive::ArgEnum, crate_name, Parser};
...
#[clap(version_short('v'), version, long_about = None)]
struct Args {
    ...
    #[clap(long, arg_enum, value_parser, default_value_t = SecurityProtocol::HybridEx)]
    security_protocol: SecurityProtocol,

    /// The keyboard type
    #[clap(long, arg_enum, value_parser, default_value_t = KeyboardType::IbmEnhanced)]
